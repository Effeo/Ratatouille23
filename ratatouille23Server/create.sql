    ...
    alter table messaggio_utente 
       add constraint FKml8hsmifhlsercfh4hd4a8enc 
       foreign key (id_messaggio) 
       references messaggio (id_messaggio) 
       on delete cascade;

    alter table messaggio_utente 
       add constraint FKp8iig3e3e9kcsdumbv1e1bmfl 
       foreign key (user_name) 
       references utente (user_name) 
       on delete cascade;
    ...
    create table ordine_piatto_seq (
       next_val bigint
    ) engine=InnoDB;

    insert into ordine_piatto_seq values ( 1 );
    ...
    create table piatto_seq (
       next_val bigint
    ) engine=InnoDB;

    insert into piatto_seq values ( 1 );
    ...
    create table piatto (
       id_piatto integer not null auto_increment,
        allergeni varchar(255),
        categoria varchar(255),
        costo float(23),
        descrizione varchar(255),
    ...
    create table ordine_piatto (
       id_ordine_piatto integer not null auto_increment,
        qta integer,
        id_ordine integer,
        id_piatto integer,
        primary key (id_ordine_piatto)
